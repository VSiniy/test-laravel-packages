<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title">{{ __('admin.activity.download_activity_title') }}</h3>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
    ...
    {{ Form::open([
      ...
      <div class="row">
        <div class="col-xs-6 col-md-4 col-lg-4 form-group {{ $errors->has('date_start') ? 'has-error' : '' }}">
          <label>{{ __('admin.activity.udate_start') }}</label><br>
        ...
        <div class="col-xs-6 col-md-4 col-lg-4 form-group {{ $errors->has('date_end') ? 'has-error' : '' }}">
          <label>{{ __('admin.activity.date_end') }}</label><br>
        ...
        <div class="col-xs-6 col-md-4 col-lg-4 form-group">
          <label>&nbsp;</label><br>
          <button type="submit" class="btn btn-primary generate-subscribed" >{{ __('admin.activity.download_activity') }}</button>
        </div>
      </div>
    {{ Form::close() }}
